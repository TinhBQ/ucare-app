...
class ForgotPassSendOTPPage extends StatefulWidget {
  const ForgotPassSendOTPPage({super.key});

  @override
  State<ForgotPassSendOTPPage> createState() => _ForgotPassSendOTPPageState();
}

class _ForgotPassSendOTPPageState extends State<ForgotPassSendOTPPage> {
